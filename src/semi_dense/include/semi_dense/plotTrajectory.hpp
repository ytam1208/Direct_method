...
Loader::Loader(std::string& path):this_name("Loader")
{
    Get_data(path);
}

bool Loader::Get_data(std::string& trajectory_file)
{
...
void Loader::DrawTrajectory(std::vector<Eigen::Isometry3d, Eigen::aligned_allocator<Eigen::Isometry3d>> poses) {
